...
import com.noduco.demoproject.service.EmployeeService;
...
//                .bean("employeeService", "processEmployeeData")
                ...
                .end()
                .process(exchange -> {
                    EmployeeService processor = exchange.getContext().getRegistry().lookupByNameAndType("employeeService", EmployeeService.class);
